...
String name="",group="",members="",logo="";
...
<h4>Welcome  <%=name%> !</h4> 
    ...
    <button type="button" class="btn btn-outline-success waves-effect" style="position:relative;width:150px;left:45%;top:-122px;"><a href="myup.jsp"><span style="position:relative;top:-7px;color:#4e504f;"><b>Uploads</b></span></a></button>
	    <button type="button" class="btn btn-outline-success waves-effect" style="position:relative;width:150px;left:57%;top:-163px;"><a href="tagaccept.jsp"><span style="position:relative;top:-7px;color:#4e504f;"><b>Requests</b></span></a></button>
    <!--Dropdown primary-->
        <div class="dropdown" style="position:relative;left:90%;top:-200px;width:160px;">
...
try
 ...
 rs1=st1.executeQuery("select * from groups");
   while(rs1.next())

   {
   group=rs1.getString(1);
    members=rs1.getString(2);  
           logo=rs1.getString(3);
        ...
        <div class="col-lg-4 col-md-12 mb-r">
            ...
            <div class="card testimonial-card">
                ...
                <div class="card-body">
                    ...
                    <a href="afterlogin2.jsp?gp=<%=group%>"><button type="button" class="btn btn-elegant">Enter</button></a>
                </div>
